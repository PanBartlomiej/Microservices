...
public class SwitchServiceTest {
    ...
    public void testGetSwitchByID_NotFound() {
        ...
        assertNull( switchService.getSwitchByID("1"));
    }
    ...
    public void testAddSwitch_AlreadyExists() {
        ...
        assertEquals("{\"responseText\":\"Product with Id= "+aSwitch.getId()+" already exists in the database\"}", response.getBody());
    }
    ...
    public void testDeleteSwitch_Success() {
        ...
        ports.add(new Port("port1",10,10, Medium.wifi, 100,"port","blue",new ArrayList<>()));
